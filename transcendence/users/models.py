...
class GameInvite(models.Model):
    ...
    init_opponent = models.IntegerField(default=0)
    
    def __str__(self):
        return f"GameInvite from {self.sender} to {self.recipient} - invite_status: {self.invite_status}, init_opponent: {self.init_opponent}"